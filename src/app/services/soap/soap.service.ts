...
export class SoapService
{
    ...
    public debug:any;
    private asynchronous:any;
    private localName:any;
    private servicePort:any;
    private servicePath:any;
    private serviceUrl:any;
    private targetNamespace:any;
    ...
    jsoResponseHandler: (response: {}, responseRaw:string) => void;
    xmlResponseHandler: (response: NodeListOf<Element>) => void;

    post(method: string, parameters: any, responseRoot?: string) : string
    {
        var _this = this;
        ...
        xmlHttp.onreadystatechange = function ()
        {
            ...
            if (4 == xmlHttp.readyState)
            {
                ...
                if(!xmlHttp.responseXML)
                {
                    ...
                    _this.jsoResponseHandler(new Error(s), xmlHttp.responseText);
                    return;
                }

                var responseNodeList:any;
                ...
                if (null != _this.jsoResponseHandler)
                {
                    ...
                    _this.jsoResponseHandler(response, xmlHttp.responseText);
                }
            }
        };
    ...
    private toElement(tagNamePotentiallyWithAttributes:any, parameters:any)
    {
    ...
    private static stripTagAttributes(tagNamePotentiallyWithAttributes:any)
    {
